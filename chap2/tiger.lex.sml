...
fun yyAction41 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (linePos := (yypos + size(yytext)) :: !linePos;
...
fun yyAction48 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        if not yylastwasn then REJECT() else ((linePos := (yypos + 1) :: !linePos;
...
fun yyAction52 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal escape character " ^ yytext); 
                                continue())
      end
...
fun yyQ109 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction54(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\r"
              then yyQ109(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp < #"\r"
              then if inp = #"\t"
                  then yyQ109(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
       ...
       of NONE =>
        ...
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\v"
                  then yyQ102(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp < #"\v"
                  then if inp = #"\t"
                      then yyQ103(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                    else if inp = #"\n"
                      then yyQ104(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                      else yyQ102(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                else if inp = #"\r"
                  then yyQ103(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                  else yyQ102(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp = #"]"
              ...
              then if inp = #"\\"
                  then yyQ106(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
                  else yyQ102(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
            else if inp = #"f"
              then yyQ103(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
              else yyQ102(strm', yyMATCH(strm, yyAction54, yyNO_MATCH))
...
fun yyQ97 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction48(strm, yyMATCH(strm, yyAction49, yyNO_MATCH))
        | SOME(inp, strm') =>
            yyAction48(strm, yyMATCH(strm, yyAction49, yyNO_MATCH))
      (* end case *))
fun yyQ96 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction48(strm, yyMATCH(strm, yyAction52, yyNO_MATCH))
        | SOME(inp, strm') =>
            yyAction48(strm, yyMATCH(strm, yyAction52, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction42(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction42(strm, yyNO_MATCH)
                  else yyQ46(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ41(strm', yyMATCH(strm, yyAction42, yyNO_MATCH))
              else yyAction42(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"A"
              ...
              then if inp = #")"
                  ...
                  then if inp = #" "
                      then yyQ5(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                    else if inp < #" "
                      then if inp = #"\v"
                          then yyQ4(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                        else if inp < #"\v"
                          then if inp = #"\t"
                              then yyQ5(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                            else if inp = #"\n"
                              then yyQ6(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                              else yyQ4(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                        else if inp = #"\r"
                          then yyQ5(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                          else yyQ4(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                    else if inp = #"&"
                      ...
                      then yyQ4(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                      else yyQ9(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                else if inp = #"0"
                  ...
                  then if inp = #"-"
                      ...
                      else yyQ16(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                else if inp = #"<"
              ...
              then if inp = #"c"
                  ...
                  then if inp = #"e"
                      ...
                      else yyQ30(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                else if inp = #"i"
              ...
              then if inp = #"p"
                  ...
                  then if inp = #"n"
                      ...
                      then yyQ23(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                      else yyQ34(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
                else if inp = #"t"
